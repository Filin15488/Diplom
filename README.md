...
<ul>
  ...
  <li> страница с добавлением новых пользователей доступна только администраторам, попасть в неё можно только из раздела на гланой странице, доступном только админам </li>
